...
import { processFormData, handleRelations } from '@/lib/utils/_helpers';
...
async function create(data) {
  ...
  let { createData, file, files } = await processFormData(data);

  const { category, subCategory, gallery, supplier, ...otherData } = createData;
